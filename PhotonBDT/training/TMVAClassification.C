...
void TMVAClassification( TString myMethodList = "" )
{
   ...
   TMVA::DataLoader *dataloader = new TMVA::DataLoader("dataset_photonBDT");
...
;
   ...
   dataloader->AddVariable("DCA", "DCA", "[cm]", 'D');
   ...
   dataloader->AddVariable("ChiPIDProton", "ChiPIDProton", "", 'D');
   //dataloader->AddVariable("ChiPIDMuon", "ChiPIDMuon", "", 'D');
   //dataloader->AddVariable("ChiPIDPion", "ChiPIDPion", "", 'D');
   //dataloader->AddVariable("BraggPIDProton", "BraggPIDProton", "", 'D');
   dataloader->AddVariable("BraggPIDMuon", "BraggPIDMuon", "", 'D');
   //dataloader->AddVariable("BraggPIDPion", "BraggPIDPion", "", 'D');
   dataloader->AddVariable("LLRPIDReduced", "LLRPIDReduced", "", 'D');
   ...
   TCut mycuts = "Completeness > 0.5 && Purity > 0.5"; // for example: TCut mycuts = "abs(var1)<0.5 && abs(var2-0.5)<1";
